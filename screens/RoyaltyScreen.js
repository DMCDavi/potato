      ...
      <View style={Style.container}>
        ...
        <ScrollView>
          ...
          <View style={Style.view_text_clinic}>
            ...
            <MonoText style={Style.text1_clinic}>
              Esse é Davi, mais comumente conhecido como Veganinho Gameplays, nome engraçado para um vegetariano que tinha um canal de gameplay no youtube.
              Mas isso é passado, agora ele desenvolveu a habilidade de assumir diversas formas animais, como gado e macaco. Tenha cuidado, talvez seu gosto peculiar por menores de idade
              tenha criado tamanha insanidade mental que até um gato e um calango se arrependeram de estarem em seu caminho.
            </MonoText>
          </View>
          <View style={{ width: '100%', height: 400, }}>
          ...
          <View style={Style.view_text_clinic}>
            ...
            <MonoText style={Style.text1_clinic}>
              Esse é Grão, as vezes zinho as vezes zão, todo dia aparece com uma forma nova de perder um emprego, tão emo que parece que não saiu de 2010.
              PS: não escutem matuê perto dele que ele surta
            </MonoText>
          </View>
          <View style={{ width: '100%', height: 400, }}>
