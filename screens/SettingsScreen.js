  ...
  render() {
    return (
      <View style={Style.container}>
        ...
        <ScrollView>
          <View style={{ width: '100%', height: 286, }}>
            <Image source={{ uri: 'https://i.ytimg.com/vi/L1tx-wAI6Nw/maxresdefault.jpg' }} style={Style.img_clinic} />
          </View>
          
            <View style={Style.view_text_clinic}>
              <MonoText style={Style.text1_clinic}>DescriçãoSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS</MonoText>
            </View>
